...
def test_has_targets(target_nested_dict_track):
    ...
    source_var: Variable = source_track.variables["source_var_2"]
...
def test_tree_from_target_var_2(target_nested_dict_track):
    ...
    var: Variable = target_nested_dict_track.variables["target_var_2"]
    expected: Dict = {
        "title": "second_target",
        "varId": "target_var_2",
        "dataType": "Integer"
...
def test_tree_from_source_folder_1(source_nested_dict_track):
    var: Variable = source_nested_dict_track.variables["source_folder_1"]
    expected: Dict = {
        "title": "outer_s",
