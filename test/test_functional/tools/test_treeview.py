...
def test_source_schema(source_schema):
    ...
    temporal
     ...
     ║     ╚═ 1 a_named_list (NamedList | source_t_named_list_1)
     ║        ╚═ 0 some_text (Text | source_t_named_list_text_1)
     ╚═ 0 second_temporal_folder (Folder | source_t_folder_2)
        ...
        ╚═ 1 a_list (List | source_t_list_2)
           ...
           ╚═ 1 a_named_list (NamedList | source_t_named_list_2)
              ╚═ 0 some_text (Text | source_t_named_list_text_2)
    ...
    immutable
     ...
     ║     ╚═ 1 a_named_list (NamedList | source_i_named_list_1)
     ║        ╚═ 0 some_text (Text | source_i_named_list_text_1)
     ╚═ 0 second_immutable_folder (Folder | source_i_folder_2)
        ...
        ╚═ 1 a_list (List | source_i_list_2)
           ...
           ╚═ 1 a_named_list (NamedList | source_i_named_list_2)
              ╚═ 0 some_text (Text | source_i_named_list_text_2)
    """).strip()
    ...
    temporal
     ╚═ 0 temporal_folder (Folder | target_t_folder)
        ...
        ╚═ 1 a_list (List | target_t_list)
           ...
           ╚═ 1 a_named_list (NamedList | target_t_named_list)
              ╚═ 0 some_text (Text | target_t_named_list_text)
    ...
    immutable
     ╚═ 0 immutable_folder (Folder | target_i_folder)
        ...
        ╚═ 1 a_list (List | target_i_list)
           ...
           ╚═ 1 a_named_list (NamedList | target_i_named_list)
              ╚═ 0 some_text (Text | target_i_named_list_text)
    """).strip()
